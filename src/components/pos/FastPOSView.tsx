    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.saleId) {
          setTimeout(async () => {
            try {
              console.log('🖨️ FastPOS: Printing receipt for sale:', result.saleId);
              
              // Prepare offline data for receipt printing
              ...
              console.log('🖨️ FastPOS: Receipt printed successfully');
            } catch (printError) {
              console.error('🖨️ FastPOS: Print error:', printError);
