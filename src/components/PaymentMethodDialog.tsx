          ...
          >
            <motion.div variants={itemVariants}>
              <Button
                ...
                className={`flex flex-col items-center justify-center p-4 h-auto transition-all duration-300 ${
                  selectedMethod === 'cash' ? 'bg-primary shadow-lg scale-105' : 'bg-secondary'
                }`}
              >
            ...
            <motion.div variants={itemVariants}>
              <Button
                ...
                className={`flex flex-col items-center justify-center p-4 h-auto transition-all duration-300 ${
                  selectedMethod === 'card' ? 'bg-primary shadow-lg scale-105' : 'bg-secondary'
                }`}
              >
            ...
            <motion.div variants={itemVariants}>
              <Button
                ...
                className={`flex flex-col items-center justify-center p-4 h-auto transition-all duration-300 ${
                  selectedMethod === 'transfer' ? 'bg-primary shadow-lg scale-105' : 'bg-secondary'
                }`}
              >
