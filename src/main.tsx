...
import { initAutoSync } from '@/utils/syncBackup'
...
const initializeApp = async () => {
  try {
    ...
    // Iniciar sincronización automática después de un breve retraso
    setTimeout(() => {
      logInit('Initializing auto sync system...');
      initAutoSync();
      logInit('Auto sync system initialized successfully');
    }, 1000);
