  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="container mx-auto p-4 relative min-h-screen">
        {/* Changed layout to prevent BackButton overlap */}
        ...
        <div className="max-w-2xl mx-auto mt-0">
          <Card className="bg-[#111111] border-zinc-950">
            <CardHeader className="flex flex-row items-center justify-between border-b border-zinc-950">
              {/* Removing title here because it's in header above */}
              <div className="flex items-center gap-2">
                <List className="text-orange-500" />
                {/* Removed CardTitle here to avoid duplication */}
              </div>
              <Button
                size="sm"
                variant="outline"
            ...
            <CardContent className="p-4">
              ...
              >
                <Input
                  ...
                  required
                  className="bg-[#1A1A1A] border-[#333333] focus:border-orange-500 text-white"
                />
                <Input
                  type="number"
                  min={1}
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-zinc-800">
                        <th className="text-left py-2 text-zinc-300">Ingrediente</th>
                        <th className="text-left py-2 text-zinc-300">Stock (g)</th>
                        <th className="py-2 text-zinc-300">Ajustar</th>
                    ...
                    <tbody>
                      {ingredients.map(ingredient =>
                        editId === ingredient.id ? (
                          ...
                          <tr key={ingredient.id} className="border-b border-zinc-800 hover:bg-[#252525]">
