...
import { Loader2, Save, FolderOpen, AlertTriangle, Cloud } from "lucide-react";
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-white">
            ...
            Te recomendamos configurar respaldos automáticos a Google Cloud Storage para mayor seguridad.
          </p>
          <div className="mt-4">
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1 text-white">
              ...
              <li>Utiliza Google Cloud Storage para tener respaldos en la nube</li>
