...
const Customers = () => {
  ...
  // This function formats the customer address, handling both string and object types
  const formatAddress = (address: string | { street: string; reference?: string } | undefined): string => {
    if (!address) return "—";
