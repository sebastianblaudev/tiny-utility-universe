...
import SupabaseStorageTest from "./pages/SupabaseStorageTest";
import AdminStats from "./pages/AdminStats";
import PCloudStats from "./pages/PCloudStats";
      ...
      <Router>
        <AuthProvider>
          <Routes>
            ...
            {/* Agregar la nueva ruta para la prueba de Google Drive */}
